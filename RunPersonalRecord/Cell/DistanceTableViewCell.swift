...
class DistanceTableViewCell: UITableViewCell {
    ...
    func setupCell(distance: Distance, name: String, duration: String) {
        switch distance{
        case .Marathon:
            distanceLabel.text = Utilities.manager.getDistanceInKmAsString(distance: distance.rawValue) + " (Marathon)"
        case .Halfmarathon:
            distanceLabel.text = Utilities.manager.getDistanceInKmAsString(distance: distance.rawValue) + " (Halfmarathon)"
        case .Mile:
            distanceLabel.text = Utilities.manager.getDistanceInKmAsString(distance: distance.rawValue) + " (Mile)"
        default:
